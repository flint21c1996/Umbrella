...
public partial class MapToolWindow : EditorWindow
{
    ...
    {
        if (neighborSnapMode == NeighborSnapMode.Face || neighborSnapMode == NeighborSnapMode.FaceExact)
        {
